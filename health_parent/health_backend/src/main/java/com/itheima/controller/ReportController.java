...
public class ReportController {
    ...
    public Result getMemberReport()throws Exception {
        ...
        try {
            List<Integer> integerList=  reportService.getMemberReport(list);
    ...
    @RequestMapping("/getBusinessReportDate")
    public Result getBusinessReportDate()  {
        try {
    ...
    public Result exportBusinessReport(HttpServletRequest request, HttpServletResponse response){
        try{
            ...
            response.setHeader("content-Disposition", "attachment;filename="+reportDate+"report.xlsx");//指定以附件形式进行下载
            excel.write(out);
